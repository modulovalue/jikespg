...
///      the SP rules.
static void compute_sp_map(const int symbol, struct SPData *spd, short *sp_rules, short *rule_list, short *index_of, short *next_rule, short *stack, struct ruletab_type *rules) {
